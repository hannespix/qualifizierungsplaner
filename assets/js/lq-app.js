...
var h=R.createElement, STORAGE='lq-dashboard-v28-events', LEGACY_STORAGE=['lq-dashboard-v27-events','lq-dashboard-v26-events','lq-dashboard-v25-events'], VIEW='lq-dashboard-v28-view', VIEW_OLD='lq-dashboard-v27-view', SETTINGS='LQ_SETTINGS_V26';
...
class App extends R.Component{
  constructor(p){super(p);var v='overview',events=safeLoad();try{v=localStorage.getItem(VIEW)||localStorage.getItem(VIEW_OLD)||v}catch(e){}if(ANSICHTEN.every(function(a){return a.id!==v}))v='overview';this.state={events:events,settings:safeLoadSettings(events),view:v,search:'',year:'all',optionsOpen:false,editing:null,creating:null,calendarMonth:new Date(2026,10,1),icsOpen:false,pdfOpen:false,printReport:null};this.setView=this.setView.bind(this);this.saveEvent=this.saveEvent.bind(this);this.removeEvent=this.removeEvent.bind(this);this.exportICS=this.exportICS.bind(this);this.printPdf=this.printPdf.bind(this);this.runPrint=this.runPrint.bind(this);this.reset=this.reset.bind(this);this.addUlb=this.addUlb.bind(this);this.addCase=this.addCase.bind(this);this.saveSettings=this.saveSettings.bind(this)}
  ...
  reset(){if(confirm('Alle eigenen Änderungen und persönlichen Optionen verwerfen und Ausgangsdaten der V2.8 wiederherstellen?')){var events=D.makeDefaultEvents();this.setState({events:events,settings:defaultSettings(events)})}}
    ...
    return h('div',{className:'lq-shell'},
      ...
      h('main',{className:'bw-app bw-app--weit lq-inhalt',id:'inhalt'},
        h('div',{className:'lq-titelzeile'},
          ...
          h(Badge,{kind:'neutral'},'V2.8 · Ausbildungsplan 15.09.2026')),
        h(Werkzeugleiste,{
        ...
        ansicht,
        h('div',{className:'footnote'},h(Icon,{name:'lock',size:14}),' Optional bleibt fachlich geschützt. Deine Optionen steuern nur, welche freiwilligen Veranstaltungen in Übersicht, Kalender, Terminliste und Standardexporten auftauchen.'),
